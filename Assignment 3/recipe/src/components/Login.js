    ...
    return (
      <div className='login-form'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <FormInput type={'text'} name={'email'} placeholder={'Email'} value={formState.email} handleChange={handleChange} />
            <span className='error-message'>{formState.emailError}</span>

            <FormInput type={'password'} name={'password'} placeholder={'Password'} value={formState.password} handleChange={handleChange} />
